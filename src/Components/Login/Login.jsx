...
<button
        ...
        <Link to="/register" ><span>don't you have an account <span className="text-blue-500 underline underline-offset-4">Register</span> now</span></Link>
      
</div>
<Link className="text-blue-400" to="/forgetpassword">Forget Password</Link>
      </form>
    </>
  );
}
